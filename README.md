...
The contents of this package require some third-party python libraries:
-PyTorch
-Matplotlib
-FrEIA
-tqdm

you can install them manually or by following the installation instructions below
